                        ...
                        <div class="form-group {{ $errors->has('type_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="type_id">
                                    ...
                                    @foreach($type as $one)
                                        <option <?=(old('type_id', $one->id) == $row->type_id ? 'selected="selected"' : '')?> value="{{$one->id}}">{{$one->title}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group {{ $errors->has('source_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                @foreach($source as $one)
                                    <option <?=(old('source_id', $one->id) == $row->source_id ? 'selected="selected"' : '')?> data-url="{{$one->image_url}}" value="{{$one->id}}">{{$one->title}}</option>
                                @endforeach
                                </select>
