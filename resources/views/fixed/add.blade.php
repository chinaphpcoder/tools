    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('fixed_create')}}" role="form">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                            <label class="col-sm-2 control-label">广告位名称<span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group {{ $errors->has('display_position') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <label class="checkbox-inline">
                                    <input type="checkbox"  name="display_position[]" value="recharge-result">充值结果页
                                </label>
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="display_position[]" value="withdraw-result">提现结果页
                                </label>
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="display_position[]" value="invest-result">投资结果页
                                </label>
