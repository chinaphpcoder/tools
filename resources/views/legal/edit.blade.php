                ...
                <form method="POST" action="{{route('legal_update')}}" role="form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('url_pc') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="url_pc" placeholder="请输入网址" value="{{ old('url_pc', $row->url_pc) }}">
                        ...
                        <div class="form-group {{ $errors->has('url_mobile') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="url_mobile" placeholder="请输入网址" value="{{ old('url_mobile', $row->url_mobile) }}">
                        ...
                        <div class="form-group {{ $errors->has('published_at') ? ' has-error' : '' }}">
                            ...
                            <div class='input-group date' id='datetimepicker1'>
                                <input type='text' name="published_at" placeholder="请选择时间" class="form-control" value="{{ old('published_at', $row->published_at) }}" />
