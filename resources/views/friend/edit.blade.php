                ...
                <form class="form-horizontal" method="POST" action="{{route('friend_update')}}" role="form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" rows="3" placeholder="300字以内">{{old('description', $row->description)}}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('sort') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="sort" placeholder="请输入排序值[数值越高，优先级越高]" value="{{ old('sort', $row->sort) }}">
                                @if ($errors->has('sort'))
                                    <span class="help-block">
