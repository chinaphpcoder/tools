...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('pcbanner_index')}}">H5项目管理</a></li>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <a href="{{route('pcbanner_index')}}" class="btn btn-default" type="button">返回列表</a>
                </div>
                <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('pcbanner_update')}}" role="form">
                    {{ csrf_field() }}
