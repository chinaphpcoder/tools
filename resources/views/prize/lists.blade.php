...
<script type="text/javascript">
    function export_all() {
        var url = "{{ route('activity_prize_export',$identification) }}" + @if(isset($conditions['is_test'])) '?is_test={{ $conditions['is_test'] }}' @else '' @endif;
        window.open(url,"_self");
    }
    function export_conditions() {
        var param = $("#prize-conditions").serialize();
        var url = "{{ route('activity_prize_export',$identification) }}" + '?' + param;
        window.open(url,"_self");
    }
</script>
@endsection