        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <a href="{{route('carousel_list')}}" class="btn btn-default" type="button">返回列表</a>
                </div>
                <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{route('carousel_update')}}" role="form">
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('image_url') ? ' has-error' : '' }}">
                            <label class="col-sm-2 control-label">上传图片<span class="text-danger">*</span>[pc端 750x320像素]</label>
                            <div class="col-sm-10">
