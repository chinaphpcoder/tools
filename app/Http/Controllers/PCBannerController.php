...
class PCBannerController extends Controller
{
    ...
    {
        $this->view_data['meta_title'] = '新增PC轮播图';
        return view('pcbanner.add', $this->view_data);
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($new_image) { //有图片
            try {
                $image_path = $image_url->store('pcbanner', 'oss');
            } catch (\Exception $e) {
                $image_path = $image_url->store('pcbanner', 'oss');
            }
        ...
        if ($result) {
            return $this->success(route('pcbanner_index'));
        } else {
    ...
    public function edit(Request $request)
    {
        ...
        $this->view_data['meta_title'] = '编辑PC轮播图';
        return view('pcbanner.edit', $this->view_data);
    }
    ...
    public function destroy(Request $request)
    {
        ...
        if ($result) {
            return $this->success(route('pcbanner_index'), '删除成功');
        } else {
    ...
    public function status(Request $request)
    {
        ...
        if ($row->save()) { //保存成功执行
            return $this->success(route('pcbanner_index', ['status' => $request->input('status')]));
        } else {
